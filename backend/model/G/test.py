...
new_features = data.drop('Governance_Score', axis=1)
new_target = data['Governance_Score']
...
data['difference'] = data['Predicted_Score'] - data['Governance_Score']

# Save results
# data.to_excel('../outcomes/G_Outcome.xlsx', index=False)
